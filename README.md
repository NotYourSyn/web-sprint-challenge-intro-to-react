...
// React.js is a library for building user interfaces on the web using reusable components. It solves the problem of manipulating the DOM. The DOM only changes when and where it needs to based off of state changes.

1. Describe component state.

// State is data in your application that will change over time and cause a re-render of the virtual DOM.

1. Describe props.

// Props is state or potenitally other data passed down to a component.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

// Side effects are anything that affects something outside the scope of the function being executed. You can sync effects to state, using UseEffect, the dependency array. In it, you pass any state or prop value that you want the effect to be attached to.
